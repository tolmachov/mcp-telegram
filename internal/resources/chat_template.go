...
// browsable MCP resource at telegram://chats/{chat_id}/info. Per MCP spec,
// resource templates let one registration serve many URIs — instead of
// registering one resource per chat, the host can construct any URI matching
// the template and the server fetches the data on demand.
//
