...
// reports a stale peer.
func withPeerRetry[T any](ctx context.Context, p *Provider, chatID int64, related []int64, operation func(tg.InputPeerClass) (T, error)) (T, error) {
	var zero T
	...
	if err == nil || !tgclient.ShouldRefreshPeer(err) {
		return result, err
	}
