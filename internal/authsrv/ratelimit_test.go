...
func TestIPRateLimiterUsesConfiguredProxyHop(t *testing.T) {
	...
	assert.True(t, l.limiter.Allow(clientIPFromXFF("203.0.113.1, 198.51.100.7")))
	assert.False(t, l.limiter.Allow(clientIPFromXFF("203.0.113.2, 198.51.100.7")),
		"rotating the client-supplied XFF prefix must not evade the limit")
	assert.True(t, l.limiter.Allow(clientIPFromXFF("203.0.113.3, 198.51.100.8")))
}
